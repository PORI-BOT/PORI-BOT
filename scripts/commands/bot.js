...
(event.body.toLowerCase() == "Bow ki")) {
  ...
  if ((event.body.toLowerCase() == "ridoy") || (event.body.toLowerCase() == "Ridoy")) {
   ...
   if ((event.body.toLowerCase() == "Neha") || (event.body.toLowerCase() == "ex")) {
   ...
   if ((event.body.toLowerCase() == "gf daw") || (event.body.toLowerCase() == "bf daw")) {
   ...
   if ((event.body.toLowerCase() == "bow daw bot") || (event.body.toLowerCase() == "Bow daw bot")) {
     return api.sendMessage("️যেখানে আমার Boss সিংগেল😼সেখানে তোগু বউ দিয়া তো বিলাসিতা😼🔪😤সর সাইডে চাপ😼", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "বউ দাউ") || (event.body.toLowerCase() == "বউ দে")) {
     return api.sendMessage("যেখানে আমার Boss সিংগেল😼সেখানে তোগু বউ দিয়া তো বিলাসিতা😼🔪😤সর সাইডে চাপ😼", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "jamay daw") || (event.body.toLowerCase() == "Jamay daw")) {
     return api.sendMessage("আমার বস ফারহান কে চোখে দেখো না নাকি__😒🥱", threadID);
   };
...
(event.body.toLowerCase() == "tomar basar sobai kmon ache")) {
  ...
  if (event.body.indexOf("Pori") == 0 || (event.body.indexOf("Mim") == 0)) {
    var msg = {
      body: `${name}, ${rand}`
    }
